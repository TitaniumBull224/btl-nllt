    ...
    def test_class_with_simple_function(self):
        ...
        expect = str(
            Program(
                [
                    ClassDecl(
                        Id("main"), [MethodDecl(Id("a"), [], VoidType(), Block([]))]
                    )
                ]
            )
        )
                        ...
                        [
                            ...
                            MethodDecl(
                                ...
                                Block(
                                    [
                                        CallStmt(
                                            Id("io"), Id("printInt"), [IntLiteral(4)]
                                        )
                                    ]
                                ),
                            ),
