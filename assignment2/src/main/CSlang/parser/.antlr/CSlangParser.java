...
public class CSlangParser extends Parser {
	...
	public static final int
		...
		RULE_lhsstat = 44, RULE_lhsparen = 45, RULE_stmtinvoc = 46, RULE_stmtinvocstat = 47, 
		RULE_stmtdecl = 48;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"stmtinvoc", "stmtinvocstat", "stmtdecl"
		};
	}
	...
	private StmtinvocContext stmtinvoc(int _p) throws RecognitionException {
		...
		int _startState = 92;
		enterRecursionRule(_localctx, 92, RULE_stmtinvoc, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
